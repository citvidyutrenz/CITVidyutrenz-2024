...
const Section = () => {
  ...
  <motion.div
    ...
    <p className="text-white p-6 pt-0 text-xs md:text-xl font-serif">
      A chance to have a glimpse of hardware infrastructure to enhance your
      technical skillset. Workshop gives insights into emerging and existing
      fields of technology and also provides interactive learning experiences.
      You can develop technical and network skills aiding in career advancement.
    </p>
    <motion.button
...
>
  ...
  >
    ...
    <p className="text-white p-6 pt-0 text-xs md:text-xl font-serif">
      The Tech-combat is on, arm yourself in the Tech-filled room and prepare
      yourself for an exciting day. Get into the venue of exposure, a platform
      to showcase your technical skills. Have your ticket to the tech World.
    </p>
    <motion.button
      initial={{ opacity: 0, y: 50 }} // Initial animation state (bottom to top)
      animate={{ opacity: 1, y: 0 }} // Animation when it's visible
